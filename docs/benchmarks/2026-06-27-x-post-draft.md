...
제가 만든 `realtime-voice-runtime`을 공개합니다.
...
https://github.com/MeroZemory/realtime-voice-runtime

## English

I built `realtime-voice-runtime`: a low-latency multilingual voice-agent runtime on OpenAI Realtime GA.
